        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <span className="text-lg font-light">info@zolaraholdings.com</span>
            </a>
            ...
            >
              ...
              <span className="text-lg font-light">+233 594 922 679</span>
            </a>
            
            {/* Address */}
            <div className="flex items-center justify-center gap-4 text-muted-foreground">
              <MapPin className="w-5 h-5 text-primary/70" />
              <span className="text-lg font-light">Tamale, Ghana</span>
            </div>
          </div>
        </div>
      </div>
